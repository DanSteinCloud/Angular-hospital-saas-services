 ...
 updateForm(patientId, dossierId, id, p,typeId) {
  ...
  switch(typeId){
    ...
    case 8:
      ...
      break;
    case 9:
      url =`${environment.baseUrl}/patients/${patientId}/dossierPrenatal/${dossierId}/antecedentObstetrical/${id}`;
      break;
...
createForm (patientId, dossierId, p,typeId){
  ...
  switch(typeId){
    ...
    case 8:
      ...
      break;
    case 9:
      url =`${environment.baseUrl}/patients/${patientId}/dossierPrenatal/${dossierId}/antecedentObstetrical`;
      break;
  }
...
findGeneric(idPatient,dossierId,typeId){
  ...
  switch(typeId){
    ...
    case 8:
      ...
      break;
    case 9:
      url =`${environment.baseUrl}/patients/${idPatient}/dossierPrenatal/${dossierId}/antecedentObstetricals`;
      break;
  }
