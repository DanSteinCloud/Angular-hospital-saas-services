...
@Component({
  selector: 'app-nouvelle-hospitalisation',
  templateUrl: './nouvelle-hospitalisation.component.html',
  styleUrls: ['./nouvelle-hospitalisation.component.css']
})
export class NouvelleHospitalisationComponent implements OnInit {
