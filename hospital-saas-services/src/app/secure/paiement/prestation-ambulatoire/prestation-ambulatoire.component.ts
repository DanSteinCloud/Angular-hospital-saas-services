...
@Component({
  selector: 'app-prestation-ambulatoire',
  templateUrl: './prestation-ambulatoire.component.html',
  styleUrls: ['./prestation-ambulatoire.component.css']
})
export class PrestationAmbulatoireComponent implements OnInit {
